const obj = {
  ...
  PaymentSuccessfullyProcessed: 'Votre paiement s\'est bien passé, vous pouvez désormais accéder à l\'intégralité des podcasts de la séries.',
  PaymentUnsuccessfullyProcessed: 'Votre paiement n\'a pas pu aboutir, veuillez réessayer. Si le problème persiste, essayez avec un autre moyen de paiement.',
  Psw_Forgotten: 'Mot de passe oublié ?',
  placeholderPsw: 'Mon mot de passe',
  problemOccurredTryLater: 'Un problème vient de se produire.<br>Veuillez réessayer plus tard...',
  ...
  subscriptionWillEndRightNowDespiteBillingPeriodEnd: 'Votre désabonnement prendra effet immédiatement, indépendemment de votre cycle de prélevement.',
  Start: 'Commencer',
  Unsubscribe: 'Se désabonner',
  unsubscribeMeNow: 'Compris, me désabonner maintenant',
