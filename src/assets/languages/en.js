const obj = {
  ...
  newVerificationLinkSentInfo: 'A new verification code has just been sent to you',
  NeedaBeVerifiedToSub: 'For security reasons, you must verify your email address to be allowed to subscribe.',
  Not_the_same_psws: 'The two passwords do not match, please try again.',
  OK: 'OK',
  Other_Languages: 'Other Languages',
  Password: 'Password',
  PaymentSuccessfulyProcessed: 'Your payment was successfully processed! You can now enjoy all the lessons of the series!',
  PaymentUnsuccessfulyProcessed: 'Your payment could not be processed. Please try again later, or, if the problem persists, try another payment method.',
  ...
  subscriptionWillEndRightNowDespiteBillingPeriodEnd: 'Your subscription will end right after you will cancel it, indepentently from your billing cycle.',
  Unsubscribe: 'Unsubscibe',
  unsubscribeMeNow: 'Understood, unsubscibe me now',
