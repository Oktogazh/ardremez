const obj = {
  ...
  PaymentSuccessfulyProcessedMsg: 'Emaoc\'h o paouez bezañ karget gant berzh! Gallout a rit tizhout holl gentelioù an heuliad!',
  PaymentUnsuccessfulyProcessedMsg: 'Ho prenadenn ne c\'hallas ket mont d\'he fenn. Klaskit en-dro ha, ma pad ar gudenn, klasit gant un doare paeañ nevez.',
  placeholderPsw: 'Ger-Kµzh',
  problemOccurredTryLater: 'Ur gudenn a zo c\'hoarvezet.<br>Klaskit en-dro diwezhatoc\'h...',
  ...
  subscriptionWillEndRightNowDespiteBillingPeriodEnd: 'Ho koumanant a echuo diouzhtu goude ho tigoumanantadur, daoust pegoulz e echuo ho kelc\'hiad koumanant.',
  Unsubscribe: 'Digoumanantiñ',
  unsubscribeMeNow: 'Komprenet, digoumanantiñ diouzhtu',
  verificationLinkSent: 'Emeur o paouez kas deoc\'h ur postel gwiriekaat.<br>Ezhomm ho po anezhañ evit gwiriekaat ho kont ha gallout koumanantiñ.',
  Welcome: 'Donemat',
